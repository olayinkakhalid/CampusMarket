          ...
          <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_340px] xl:grid-cols-[minmax(0,1fr)_360px] gap-5 items-start">
            ...
            <div className="min-w-0">
              ...
              <div className="flex flex-col gap-3">
                ...
                {/* STEPS */}
                <div className="bg-[#FFFFFF] flex flex-wrap gap-x-5 gap-y-3 items-center px-4 py-4 border border-[#E5E2DC] rounded-lg">

                  {/* PHOTO */}
                  <div className="flex gap-2 items-center cursor-pointer">

                    <div className="bg-[#C67A52] text-[#FFFFFF] rounded-full w-7 h-7 flex items-center justify-center shrink-0">
                      <p>1</p>
                    </div>
                  ...
                  <div className="flex gap-2 items-center cursor-pointer">
                    ...
                    <div className="bg-[#F5F2EC] text-[#6B6B6B] border border-[#D0CCC4] rounded-full w-7 h-7 flex items-center justify-center shrink-0">
                      <p>2</p>
                    </div>
              ...
              {/* ================= PHOTOS ================= */}
              <div className="bg-[#FFFFFF] border border-[#E5E2DC] px-4 sm:px-6 lg:px-8 py-6 sm:py-7 mt-3 rounded-xl">
              ...
              {/* ================= ITEM DETAILS ================= */}
              <div className="px-4 sm:px-6 lg:px-7 py-6 sm:py-8 mt-3 border border-[#E5E2DC] bg-[#FFFFFF] rounded-xl">
                    ...
                    <div className="relative">
                      ...
                      {showCondition && (
                        ...
                        <div className="absolute z-20 top-full left-0 right-0 mt-2 p-1 bg-white/90 backdrop-blur-xl border border-white/50 rounded-xl shadow-lg shadow-black/5">
                          ...
                          {[
                            { name: "New", description: "Never used" },
                            { name: "Like New", description: "Barely used, looks new" },
                            { name: "Good", description: "Normal use, minor wear" },
                            { name: "Fair", description: "Noticeable wear, still usable" }
                          ].map((item) => (
